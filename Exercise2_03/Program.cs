...
public static class Solution {
  ...
  public static void Main(){
    ...
    var isEnough4 = IsEnough(5, new IShape[] { new Rectangle(1,1), new Circle(1), new Rectangle(1.4,1)  });

    Console.WriteLine($"IsEnough1 = {isEnough1}, " + $"IsEnough2 = {isEnough2} " + $"IsEnough1 = {isEnough1}, " + $"IsEnough2 = {isEnough2}");
  }
}